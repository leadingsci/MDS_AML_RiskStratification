...
if (TRUE) {
  ## output
  output_dir = "/share/home/wyz/Project/result/2025/202507/20250710_1_bluk_rnaseq_split_group_barplot/20250811_1_bluk_rnaseq_split_group_barplot_data_tumor"
...

{
  ...
  df_long$Group = factor(df_long$Group,
                         levels = c("OS_Year_0_1", "OS_Year_1_5", "OS_Year_5_up"))
...
# -------------------------------------------------------------------------
{
  ...
  subset(df_summary, Group == "OS_Year_0_1")
}
...

{
  plot_object = ggplot(
    ...
    geom_hline(
      data = subset(df_summary, Group == "OS_Year_0_1"),
      aes(yintercept = Mean_Value, color = Cell_Type_Mark),
      linetype = "dashed",
      size = 0.5
    ) +  #
    labs(x = NULL, y = "Percent", #
         title = "Tumor Cells Percent"  # ) +
         ...
         plot_object
         output_f_path = file.path(output_dir,
                                   "20250730_3_3_bluk_rnaseq_split_group_barplot_data_long_df.pdf")
         ggsave(
