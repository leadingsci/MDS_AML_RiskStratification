...
if (TRUE) {
  ## output
  output_dir = "/share/home/wyz/Project/result/2025/202502/20250206_1_unrice_scRNA_TNK_exp/20250207_3_scRNA_GSE_mono_M-MDSC_module_score"
  
}


if (TRUE) {
  input_f_path_GSE = "/share/home/wyz/Project/result/20240429_scRNA_GSE_TNK/20240430_scRNA_GSE_mono/scRNA_SMU_GSE116256_PRJNA720840_GSE205490_HRA000084_AML_MDS_83_origin_rds_combined_qc_STD_Harmony_res_anno_GES116256_select_mono_20240501.rds"
  ...
  table(seurat_object_STD@meta.data$GSE116256_TransferLabel)
}



{
  seurat_object_keep = seurat_object_STD
}



#  ------------------------------------------------------------
go_f_path = "/share/home/wyz/Lab/Code/ProjectCode/2024/202405/sample_info/M-MDSC_genes.xlsx"
...
score_result_cbind <- cbind(
  ...
  CellType  =  as.character(
    seurat_object_keep_module@meta.data$GSE116256_TransferLabel
  ),
  Pathway_Score = seurat_object_keep_module@meta.data$MDSC_Score1
) #
...
output_f_path = file.path(output_dir, "scRNA_GSE_mono_MDSC_Score_20240509_1.xls") #
write.table(
...
# data ------------------------------------------------------------
{
  ...
  output_f_path = file.path(output_dir,
                            "scRNA_GSE_mono_MDSC_Score_diseaseclass_mean_20240509_1.xls")  #
  write.table(
...
# ggviolin ------------------------------------------------------------
{
  ...
  seurat_object_plot =
    ...
    labs(
      x = NULL,
      y = "Module score",
      title = "M-MDSC Score(680 genes) in Monocyte cells",
      fill = "Average"
    ) +  # 添加标签和标题
  ...
  output_f_path = file.path(output_dir,
                            "scRNA_GSE_mono_MDSC_Score_diseaseclass_mean_20240523_2.pdf")
  ggsave(
...
#   ------------------------------------------------------------
{
  ...
  output_f_path = file.path(output_dir,
                            "STAT-GSE_Rice_monocyte_MDSC_Score_mean_Sample_ID_20240521_1.xls")
  write.table(
    score_result_sample_id_mean_keep_df_deldup,
    file = output_f_path,
    sep = "\t",
  ...
  seurat_object_plot = ggplot(
    ...
    theme(# legend.position = "none",
      ...
      output_f_path = file.path(
        output_dir,
        "scRNA_GSE_mono_MDSC_Score_diseaseclass_mean_Sample_ID_20240523_1.pdf"
      )
      ggsave(
        filename = output_f_path,
        plot = seurat_object_plot,
